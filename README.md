...
The Detection Lab project was developed to create a controlled environment for simulating and detecting cyberattacks.The main focus was to ingest and analyze logs within a Security Information and Event Management (SIEM) system, while also generating test telemetry to replicate realistic attack scenarios.This process strengthened understanding of network security, attack techniques, and defensive measures.
